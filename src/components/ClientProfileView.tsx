...
export const ClientProfileView: React.FC<Props> = ({ profile, onUpdateProfile }) => {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-5 animate-fade-in pb-12">
      ...
      {/* Formulario directo sin caja externa */}
      <form onSubmit={handleSaveProfile} className="space-y-4">
        ...
        <div className="flex justify-end pt-3 border-t border-zinc-800">
          <button
            type="submit"
            className="bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs py-2 px-5 rounded-xl shadow transition flex items-center gap-1.5 active:scale-98 cursor-pointer"
          >
