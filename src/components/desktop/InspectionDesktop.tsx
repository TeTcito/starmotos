    ...
    <div className="w-full space-y-6 animate-fade-in pb-16">
      ...
      <div className="grid grid-cols-5 gap-4 w-full">
        {[
          ...
          <div
            ...
            className="group relative rounded-2xl overflow-hidden border border-zinc-800 bg-zinc-900 aspect-square cursor-pointer hover:border-blue-500 transition shadow-md"
          >
      ...
      <div className="grid grid-cols-2 gap-6 w-full pt-2">
        <div className="bg-zinc-900 p-5 rounded-2xl border border-zinc-800 space-y-3">
          <span className="font-bold text-amber-400 uppercase text-xs tracking-wider block">
            Daños y Desgastes Previos al Ingreso
          </span>
          <div className="space-y-2">
            {inspection.damages.map((dmg) => (
              <div key={dmg.id} className="text-zinc-300 border-b border-zinc-800 pb-2.5 last:border-0 text-sm">
        ...
        <div className="bg-zinc-900 p-5 rounded-2xl border border-zinc-800 flex flex-col justify-between">
          <div>
            <span className="font-bold text-zinc-300 uppercase text-xs tracking-wider block mb-2">
          ...
          <p className="text-xs text-zinc-400 text-center font-mono mt-3">
            Firmado por: <strong>{inspection.signature.clientName}</strong> ({inspection.signature.identificationId})
            <br />
