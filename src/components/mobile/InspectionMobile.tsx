    ...
    <div className="space-y-4 animate-fade-in pb-12">
      <div className="flex items-center justify-between pb-3 border-b border-zinc-200">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-base font-bold text-zinc-900">Inspección 360°</h2>
        </div>
        <span className="text-[11px] font-mono text-zinc-500">{inspection.receptionDate}</span>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
        {[
          ...
          <div
            ...
            className="group relative rounded-xl overflow-hidden border border-zinc-200 bg-zinc-100 aspect-square cursor-pointer hover:border-blue-500 transition shadow-sm"
          >
      ...
      <div className="space-y-3 pt-1">
        {/* Daños Previos */}
        <div className="bg-zinc-50 p-3 rounded-xl border border-zinc-200 shadow-sm space-y-1.5 text-xs">
          <span className="font-bold text-amber-600 uppercase text-[10px] block">
            Daños Previos al Ingreso
          </span>
          {inspection.damages.map((dmg) => (
            <div key={dmg.id} className="text-zinc-700 border-b border-zinc-200 pb-1.5 last:border-0">
        ...
        <div className="bg-zinc-50 p-3 rounded-xl border border-zinc-200 shadow-sm space-y-1.5 text-xs">
          ...
          <div className="bg-white rounded-lg p-2 border border-zinc-200 flex items-center justify-center">
