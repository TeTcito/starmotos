    ...
    <div className="space-y-4 animate-fade-in pb-12">
      ...
      <div className="space-y-3">
        {scheduledMaintenances.map((maint) => (
          <div
            key={maint.id}
            className="bg-zinc-900 p-3.5 rounded-xl border border-zinc-800 space-y-2"
          >
            ...
            <div className="text-xs text-zinc-300 flex flex-col gap-0.5 border-t border-zinc-800 pt-2">
              <span>
